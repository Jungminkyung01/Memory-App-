...
public class BizCardList extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		userList.startAnimation(new AnimationUtils().loadAnimation(
				BizCardList.this, R.anim.push_left_in));
			...
			public void handleMessage(Message msg) {
				if (msg.what == 1) {
					...
					if (!firstSettingEnd) {
						...
						MyAdapter = new MyAdapter(BizCardList.this,
					...
					if (members.isEmpty() && Info.BizCardListTotalPage == 0) {
						Toast.makeText(BizCardList.this, "자료가 없습니다.", 0).show();
						...
						userList.setSelection(Info.BizCardListPosition);
					}

					Info.replay = true;
					BizCardList.curPage = Info.BizCardListPage;
		...
		searchBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try {
					Intent intent = new Intent(getApplicationContext(), BizCardListSearchText.class);
					intent.putExtra("SEARCHTEXT", "");
				...
				if (!"".equals(arSrc.get(position).MOBILE)) {
					...
					mobile.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							...
							try {
								Info.performDial(BizCardList.this,
	...
	class MyAsyncTask extends AsyncTask<Void, String, Void> {
		...
		protected void onPreExecute() {
			...
			if (progressDialog != null && progressDialog.isShowing()) {
				...
				progressDialog = new ProgressDialog(BizCardList.this);
			}
	...
	public void onResume() {
		...
		if (BizCardList.curPage != Info.BizCardListPage) {
			if (Info.BizCardListPage < Info.BizCardListTotalPage) {
